...
function about() {
  return (
    <Fragment>
      <LayoutComponent text="Our aim is to provide Free personalized and contextual recommendations and Research Communities.">
        {/* ResearchKernel's Contextual Search and Open Community Forum */}
        <Content style={{ padding: 70 }}>
          <Row gutter={16}>
            <Col span={12} offset={6}>
              <h1>Our Mission</h1>
              <p style={text_style}>
                Our objective at ResearchKernel is to not only provide a
                platform for you to do a search but also make it interactive and
                relevant. With Contextual Search, we make the tedious task of
                searching easier only show what's relevant to you that save your
                time from going through unnecessary Search Results. We also
                provide Community Forum to find like-minded people that might
                become your collaborators for your project.
              </p>
            </Col>
            <br />
          </Row>
        ...
        <Content>
          <Row gutter={16}>
            ...
            <Col span={12} offset={6}>
              <p>
                Staying Updated is very important, however not everything which
                is published will be usefull. Our Platfrom will also give you
          ...
          <Row gutter={16}>
            ...
            <Col span={12} offset={6}>
              <p>
                ...
                one of the largest free research paper proverder out there. We
                are harvesting all the research paper arxiv has in there
                database from 1999 till date, however we are not limited to
                arxiv databse, we will also incoporate other domains databses
                too in future.
              </p>
              <br />
              <p>
